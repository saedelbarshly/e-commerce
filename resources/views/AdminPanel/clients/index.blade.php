                        ...
                        <tbody>
                            ...
                            <tr id="row_{{$user->id}}">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{route('admin.clientUsers.edit',['id'=>$user->id])}}" class="btn btn-icon btn-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{trans('common.edit')}}">
