                        ...
                        <tbody class="text-center">
                            ...
                            <tr id="row_{{$company->id}}">
                                ...
                                <td class="text-center">
                                    <img src="{{ $company->photoLink() }}" alt="image" class="img-responsive rounded" width="100px" >
                                 </td>
                                <td class="text-center">
                                    {{$company->ordering}}
                                </td>
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-icon btn-danger" onclick="confirmDelete('{{$delete}}','{{$company->id}}')" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{trans('common.delete')}}">
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    ...
                                    {{Form::open(['url'=>route('admin.companies.update',['id'=>$company->id]), 'id'=>'editcompanyForm', 'class'=>'row gy-1 pt-75','files'=>true])}}
                                        <div class="col-12 col-md-6">
                                          <label class="form-label" for="name_ar">{{trans('common.name_ar')}}</label>
                                          {{Form::text('name_ar',$company->name_ar,['id'=>'name_ar', 'class'=>'form-control','required'])}}
                                        </div>
                                        <div class="col-12 col-md-6">
                                          <label class="form-label" for="name_en">{{trans('common.name_en')}}</label>
                                          {{Form::text('name_en',$company->name_en,['id'=>'name_en', 'class'=>'form-control'])}}
                                        </div>
                                        <div class="col-12 col-md-12">
                                          <label class="form-label" for="ordering">{{trans('common.ordering')}}</label>
                                          {{Form::number('ordering',$company->ordering,['id'=>'ordering', 'step'=>'1', 'class'=>'form-control','required', 'min'=>0])}}
                                        </div>
                                        <div class="col-12 col-md-12">
                                          <label class="form-label" for="keywords_ar">{{trans('common.keywords_ar')}}</label>
                                          {{Form::textarea('keywords_ar',$company->keywords_ar,['id'=>'keywords_ar','class'=>'form-control','required', 'rows'=>3])}}
                                        </div>
                                        <div class="col-12 col-md-12">
                                          <label class="form-label" for="keywords_en">{{trans('common.keywords_en')}}</label>
                                          {{Form::textarea('keywords_en',$company->keywords_en,['id'=>'keywords_en','class'=>'form-control','required', 'rows'=>3])}}
                                        </div>
                                        <div class="col-12 col-md-12">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['url'=>route('admin.companies.store'), 'id'=>'createcompanyForm', 'class'=>'row gy-1 pt-75', 'files'=>'true'])}}
                        <div class="col-12 col-md-6">
                            <label class="form-label" for="name_ar">{{trans('common.name_ar')}}</label>
