  ...
  <div class="col-12">
    ...
    <div class="card">
      ...
      <div class="card-body py-2 my-25">
        {{Form::open(['files'=>'true','class'=>'validate-form','route' => 'admin.options.store'])}}
        <!-- form -->
        <div class="row pt-3">
        ...
        <div class="col-12 col-md-12">
          ...
          {{ Form::select('option_type_id', $optionTypes->pluck('name_ar', 'id')->all(), null, ['class' => 'form-select item-details', 'id' => 'option_type_id', 'onchange'=>'showElemet(this.value)', 'placeholder' => '--إختيار النوع--']) }}
        </div>
        <div class="col-12 col-md-12">
