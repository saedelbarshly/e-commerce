    ...
    <div class="card">
      <div class="card-body">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="specifications-tab" data-bs-toggle="tab" href="#specifications" aria-controls="specifications" role="tab"
              aria-selected="false">
          ...
          <li class="nav-item">
            <a class="nav-link" id="discount-tab" data-bs-toggle="tab" href="#discount" aria-controls="discount" role="tab"
              aria-selected="false">
              <i data-feather="percent"></i> {{trans('common.discount')}}
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="specialOffer-tab" data-bs-toggle="tab" href="#specialOffer" aria-controls="specialOffer" role="tab"
              aria-selected="false">
