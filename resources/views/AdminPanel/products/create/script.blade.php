      ...
      <div class="options-list-place">
        <div class="row options-list">
          <div class="form-group row mb-2">
            ...
            <div class="col-sm-10">
              {{Form::select('optionRequired[]',[
                1 => "نعم",
                0 => "لا",
              ],'',['id'=>'optionRequired','class'=>'form-control'])}}
            </div>
          </div>
          <div class="col-12 col-sm-2 mb-1">
            <label class="form-label" for="option_value_id">{{trans('common.optionValue')}}</label>
            {{ Form::select('option_value_id[]', $optionValues, null, ['class' => 'form-control option-value','id'=>'option_value_id']) }}
          </div>
          <div class="col-12 col-sm-2 mb-1">
            <label class="form-label" for="optionQuantity">{{trans('common.quantity')}}</label>
            <input type="number" name="optionQuantity[]" id="optionQuantity" class="form-control option-quantity" min=0>
          </div>
          <div class="col-12 col-sm-3 mb-1">
            <label class="form-label" for="optionDiscountFromAvailableProducts">{{trans('common.discountFromAvailableProducts')}}</label>
          ...
          <div class="col-12 col-sm-2 mb-1">
            ...
            <input type="number" name="optionPrice[] " step="1" id="optionPrice"
              class="form-control option-optionPrice" min=0>
          </div>
  ...
  function getOptionInputs(elem) {
    ...
    $.ajax({    //create an ajax request to display.php
        ...
        success: function(data){ 
          ...
          // var optionValueList = $.parseJSON(data);
          // //populate optionValueList options
          // var optionValueListOption = '';
          // optionValueListOption += '<option value="">اختر الصنف</option>';
          // for (var i=0;i<optionValueList.length;i++){
          //     optionValueListOption += '<option value="'+optionValueList[i]['id']+'">'+optionValueList[i]['name']+'</option>';
          // }
          // $(optionsSection).empty().append(optionValueListOption);
        }
    });
  }
