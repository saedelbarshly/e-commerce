...
<div class="row">
    ...
    <div class="col-12 col-md-12">
        ...
        {{Form::textarea('metadata_ar',$product->metadata_ar,['rows'=>'3','id'=>'metadata_ar','class'=>'form-control', 'required'])}}
    </div>
    <div class="col-12 col-md-12">
        <label class="form-label" for="metadata_en">{{trans('common.metadata_en')}}</label>
        {{Form::textarea('metadata_en',$product->metadata_en,['rows'=>'3','id'=>'metadata_en','class'=>'form-control', 'required'])}}
    </div>
    <div class="col-12 col-md-12">
