...
@section('content')
  ...
  <!--  dashboard section start -->
    <section class="dashboard-section section-b-space user-dashboard-section mb-4">
      <div class="container">
        <div class="row">
          <div class="col-lg-3">
              ...
              <div class="faq-tab">
                <ul class="nav nav-tabs" id="top-tab" role="tablist">
                  <li class="nav-item"><a data-bs-toggle="tab" data-bs-target="#info" class="nav-link active">Account
                      Info</a></li>
                  <li class="nav-item"><a data-bs-toggle="tab" data-bs-target="#address" class="nav-link">Address Book</a>
                  </li>
                  <li class="nav-item"><a data-bs-toggle="tab" data-bs-target="#orders" class="nav-link">My Orders</a></li>
                  <li class="nav-item"><a data-bs-toggle="tab" data-bs-target="#wishlist" class="nav-link">My Wishlist</a>
                  </li>
                  <li class="nav-item"><a data-bs-toggle="tab" data-bs-target="#payment" class="nav-link">Saved Cards</a>
                  </li>
                  <li class="nav-item"><a data-bs-toggle="tab" data-bs-target="#profile" class="nav-link">Profile</a></li>
                  <li class="nav-item"><a data-bs-toggle="tab" data-bs-target="#security" class="nav-link">Security</a>
                  </li>
                        ...
                        <div class="address-book-section">
                          <div class="row g-4">
                            <div class="select-box active col-xl-4 col-md-6">
                              <div class="address-box">
                                <div class="bank-logo">
                                  <img src="{{ asset('frontend/assets/images/bank-logo.png') }}" class="bank-logo">
                                  <img src="{{ asset('frontend/assets/images/visa.png') }}" class="network-logo">
                                </div>
                            ...
                            <div class="select-box col-xl-4 col-md-6">
                              <div class="address-box">
                                <div class="bank-logo">
                                  <img src="{{ asset('frontend/assets/images/bank-logo1.png') }}" class="bank-logo">
                                  <img src="{{ asset('frontend/assets/images/visa.png') }}" class="network-logo">
                                </div>
                                <div class="card-number">
                                  <h6>Card Number</h6>
